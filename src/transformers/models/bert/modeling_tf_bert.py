...
class TFBertEncoder(tf.keras.layers.Layer):
    ...
    def _get_intervals(self, x):
        ...
        assert len(interval05.shape) == 1 and interval05.shape[0] == 1, f"intervalx.shape: {interval05.shape}"
        ...
        assert len(interval10.shape) == 1 and interval10.shape[0] == 1, f"intervalx.shape: {interval10.shape}"
        ...
        assert len(interval15.shape) == 1 and interval15.shape[0] == 1, f"intervalx.shape: {interval15.shape}"
        ...
        assert len(interval20.shape) == 1 and interval20.shape[0] == 1, f"intervalx.shape: {interval20.shape}"
        ...
        assert len(interval25.shape) == 1 and interval25.shape[0] == 1, f"intervalx.shape: {interval25.shape}"
        ...
        assert len(interval30.shape) == 1 and interval30.shape[0] == 1, f"intervalx.shape: {interval30.shape}"
        ...
        assert len(interval35.shape) == 1 and interval35.shape[0] == 1, f"intervalx.shape: {interval35.shape}"
        ...
        assert len(interval40.shape) == 1 and interval40.shape[0] == 1, f"intervalx.shape: {interval40.shape}"
        ...
        assert len(interval45.shape) == 1 and interval45.shape[0] == 1, f"intervalx.shape: {interval45.shape}"
        ...
        assert len(interval50.shape) == 1 and interval50.shape[0] == 1, f"intervalx.shape: {interval50.shape}"
        ...
        assert len(interval55.shape) == 1 and interval55.shape[0] == 1, f"intervalx.shape: {interval55.shape}"
        ...
        assert len(interval60.shape) == 1 and interval60.shape[0] == 1, f"intervalx.shape: {interval60.shape}"
        ...
        assert len(interval65.shape) == 1 and interval65.shape[0] == 1, f"intervalx.shape: {interval65.shape}"
        ...
        assert len(interval70.shape) == 1 and interval70.shape[0] == 1, f"intervalx.shape: {interval70.shape}"
        ...
        assert len(interval75.shape) == 1 and interval75.shape[0] == 1, f"intervalx.shape: {interval75.shape}"
        ...
        assert len(interval80.shape) == 1 and interval80.shape[0] == 1, f"intervalx.shape: {interval80.shape}"
        ...
        assert len(interval85.shape) == 1 and interval85.shape[0] == 1, f"intervalx.shape: {interval85.shape}"
        ...
        assert len(interval90.shape) == 1 and interval90.shape[0] == 1, f"intervalx.shape: {interval90.shape}"
        ...
        assert len(interval95.shape) == 1 and interval95.shape[0] == 1, f"intervalx.shape: {interval95.shape}"
        ...
        assert len(interval100.shape) == 1 and interval100.shape[0] == 1, f"intervalx.shape: {interval100.shape}"
